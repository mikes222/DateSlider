...
import com.mschwartz.dateslider.SliderContainer.OnTimeChangeListener;
...
public class DateSlider extends DialogFragment {
    ...
    public static final String ARG_STARTHOUR = "starthour";
    public static final String ARG_ENDHOUR = "endhour";
    public static final String ARG_INITIALTIME = "initialtime";
    public static final String ARG_LAYOUTID = "layoutid";
    public static final String ARG_MINTIME = "mintime";
    public static final String ARG_MAXTIME = "maxtime";
    public static final String ARG_MINUTEINTERVAL = "minuteinterval";
    ...
    public static DateSlider newInstance(Bundle args) {
        DateSlider fragment = new DateSlider();
     ...
     */
    public DateSlider() {
        mLayoutID = R.layout.defaultdatetimeslider;
    ...
    /**
     * Parse arguments supplied when instantiating that fragment. It will be called only if there are arguments to read.
     * #onRestoreInstanceState will be called afterwards. There is NO UI available at this stage.
     *
     * @param bundle
     */
    protected void parseArguments(Bundle bundle) {
        if (bundle.get(ARG_STARTHOUR) != null)
            tempTimeBoundaries.startHour = bundle.getInt(ARG_STARTHOUR);
        if (bundle.get(ARG_ENDHOUR) != null)
            tempTimeBoundaries.endHour = bundle.getInt(ARG_ENDHOUR);
        if (bundle.get(ARG_INITIALTIME) != null)
            mInitialTime = bundle.getLong(ARG_INITIALTIME);
        if (bundle.get(ARG_LAYOUTID) != null)
            mLayoutID = bundle.getInt(ARG_LAYOUTID);
        if (bundle.get(ARG_MINTIME) != null)
            tempTimeBoundaries.minTime = bundle.getLong(ARG_MINTIME);
        if (bundle.get(ARG_MAXTIME) != null)
            tempTimeBoundaries.maxTime = bundle.getLong(ARG_MAXTIME);
        if (bundle.get(ARG_MINUTEINTERVAL) != null)
            tempTimeBoundaries.minuteInterval = bundle.getInt(ARG_MINUTEINTERVAL);
     ...
     * @return
     */
    protected DateSlider setLayout(int layoutID) {
        mLayoutID = layoutID;
        return this;
    }
     ...
     * @return DateSlider
     */
    protected DateSlider setMinTime(long minTime) {
     ...
     * @return DateSlider
     */
    protected DateSlider setMaxTime(long maxTime) {
     ...
     * @return DateSlider
     */
    protected DateSlider setMinuteInterval(int minuteInterval) {
     ...
     * @return
     */
    protected DateSlider setInitialTime(long initialTime) {
     ...
     * @return
     */
    protected DateSlider setHours(int startHour, int endHour) {
    ...
    protected void setPerformAnimation(boolean performAnimation) {
    ...
    protected DateSlider setTitle(String title) {
        this.title = title;
        if (getDialog() != null)
